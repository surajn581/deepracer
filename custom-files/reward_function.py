...
class Path:
    ...
    def on_track_reward(self, params):
        ...
        reward = 1/( (1+float(distance*2.5))**2 )
        return reward
...
class SteeringUtils:
    ...
    def reward(params):
        ...
        reward = 2/(1 + math.exp(diff)**2)  # this will give 0 to 1 in a stable smooth curve for diff between 0-180
        return reward
